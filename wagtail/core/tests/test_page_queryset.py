...
class TestPageQuerySetViewableByUser(TestCase, WagtailTestUtils):
    ...
    def test_complex_permission_heirarchy(self):
        ...
        PageViewRestriction.objects.create(page=home_page, password="abc", restriction_type=PageViewRestriction.PASSWORD)
        ...
        PageViewRestriction.objects.create(page=public_page, restriction_type=PageViewRestriction.NONE)
        ...
        PageViewRestriction.objects.create(page=public_page_3, restriction_type=PageViewRestriction.NONE)
        ...
        PageViewRestriction.objects.create(page=public_page_4, restriction_type=PageViewRestriction.NONE)
